...
INSERT INTO POST
( 
POST_ID, MEMBER_ID, MEMBER_NICKNAME, TITLE, CONTENTS, YOUTUBE_LINK, EMOTION_CODE, CREATED_AT, UPDATED_AT 
)VALUES ( '2', 'haha123', 'kk', '찾아라', '찾아라 비밀의 열쇠 미로속에 갇힌 모험들','https://www.youtube.com/watch?v=A29cDAxDsts','happy',sysdate,sysdate );
