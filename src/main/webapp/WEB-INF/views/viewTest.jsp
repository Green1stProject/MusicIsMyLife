				...
				<table class="post-list">
					...
					<tbody>
						<c:forEach var="post" items="${testList}">
							<tr>
								<td>${post.POST_ID}</td>
								<td><a href="/post/detail/${post.POST_ID}">${post.TITLE}</a></td>
								<td>${post.MEMBER_NICKNAME}</td>
								<td><span class="emotion-tag ${post.EMOTION_CODE}">${post.EMOTION_CODE}</span></td>
								<fmt:parseDate var="parsedDate" value="${post.CREATED_AT}" pattern="yyyy-MM-dd HH:mm:ss" />
